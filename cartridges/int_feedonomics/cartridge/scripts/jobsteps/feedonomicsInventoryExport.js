...
function writeInventoryExportField(product, csvProductArray, columnValue) {
    switch (columnValue) {
        ...
        case FConstants.HEADER_VALUES.ONLINE:
            ...
            break;
        case FConstants.HEADER_VALUES.CUSTOM_INVENTORTY_FIELDS:
            csvProductArray.push(FeedonomicsHelpers.getAllCustomProps(FeedonomicsHelpers.getProductInventoryRecord(product)));
            break;
        default:
