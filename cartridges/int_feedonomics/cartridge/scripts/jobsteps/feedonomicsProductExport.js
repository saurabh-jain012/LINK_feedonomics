...
function writeProductExportField(product, csvProductArray, columnValue) {
    switch (columnValue) {
        ...
        case FConstants.HEADER_VALUES.ONLINE:
            ...
            break;
            // Product's Online From Date
        case FConstants.HEADER_VALUES.ONLINE_FROM:
            csvProductArray.push(FeedonomicsHelpers.getOnlineFromDate(product));
            break;
            // Product's Online To Date
        case FConstants.HEADER_VALUES.ONLINE_TO:
            csvProductArray.push(FeedonomicsHelpers.getOnlineToDate(product));
            break;
        default:
